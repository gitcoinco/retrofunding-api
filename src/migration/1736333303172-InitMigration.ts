...
export class InitMigration1736333303172 implements MigrationInterface {
    name = 'InitMigration1736333303172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "application_to_metric_score" ("id" SERIAL NOT NULL, "identifier" character varying NOT NULL, "score" double precision NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "metricId" integer NOT NULL, CONSTRAINT "UQ_cc99a6ab599a5358656e79b32ca" UNIQUE ("identifier", "metricId"), CONSTRAINT "PK_7b77b8518b2ba4d789e4285b2c2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "application_to_metric_score" ADD CONSTRAINT "FK_2237e80d6886b794c667b483a73" FOREIGN KEY ("metricId") REFERENCES "metric"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
